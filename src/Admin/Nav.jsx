...
//           <li className='mx-4 my-6 md:my-0 text-xl duration-500 hover:text-gray-400'><Link to='/'>View uploads</Link></li>
          
//           <li className='mx-4 my-6 md:my-0 text-xl duration-500 hover:text-gray-400'><Link to='/adminleaderboard'>View Leadership board</Link></li>
//             <li className='mx-4 my-6 md:my-0 md:text-xl duration-500 bg-transparent border border-white rounded-lg md:px-6 hover:text-gray-400'><Link to='/'>Log Out</Link></li>
//         </ul>
...
function Nav() {
  ...
  const [selectedProfileId, setSelectedProfileId] = useState(1); // Default to first profile's ID
  ...
  const handleProfileChange = (id) => {
    ...
    if (newProfile) {
      ...
      setEditProfile(newProfile); // Update the profile that will be edited
    ...
    <div>
      <nav className='p-3 bg-purp font-poppins text-white shadow md:flex md:items-center md:justify-between'>
        ...
        >
          ...
          {/* Profile Section for Mobile Navigation */}
          {selectedProfile && (
            <li className='mt-8'>
